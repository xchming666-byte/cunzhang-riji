...
const BT={
  ...
  lumber:{n:'木材坊',c:'🪵',cost:{wood:3},maxW:2,prod:{wood:0.5},cons:{water:1},minLv:1,unlocked:true},
  ...
  clinic:{n:'医馆',c:'🏥',cost:{stone:10,gold:80},maxW:1,minLv:2,unlocked:false},
  school:{n:'学堂',c:'📚',cost:{stone:15,gold:120},maxW:3,minLv:2,unlocked:false},
  teahouse:{n:'茶馆',c:'🍵',cost:{stone:15,gold:150},maxW:1,minLv:3,unlocked:false},
  wall:{n:'城墙',c:'🏰',cost:{stone:50},maxW:0,minLv:3,unlocked:false},
  temple:{n:'祠堂',c:'⛩️',cost:{stone:30,gold:200},maxW:1,minLv:3,unlocked:false},
  paifang:{n:'牌坊',c:'🏛️',cost:{stone:40,gold:300},maxW:0,minLv:3,unlocked:false}
};
