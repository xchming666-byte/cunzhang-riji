...
const BT={
  ...
  school:{n:'墨家之庐',c:'⚙️',cost:{stone:15,gold:120},maxW:3,minLv:2,unlocked:false},
...
// ===================== 科技树 =====================
function openTechTree(){document.getElementById('tech-research-text').textContent=`📖 当前研究点：${Math.floor(research)}（墨家之庐学者每日产出，研究即消耗）`;renderTechList();document.getElementById('tech-overlay').classList.add('show')}
